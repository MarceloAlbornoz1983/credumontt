...
jQuery(document).ready(function () {
	...
	jQuery('.comunas' || '#comuna').html(htmlComunas);
	...
	jQuery('.comunas').submit(function () {
		if (jQuery(this).val() == 'sin-region') {
			alert('seleccione Región');
		}else if ($('#contactForm == select[name=regiones]').val('sin-region')){
	        alert('seleccione Comuna');
	} else if (jQuery(this).val() == 'sin-comuna') {
			alert('seleccione Comuna');
		}
	});
	jQuery('.regiones').submit(function () {
		if (jQuery(this).val() == 'sin-region') {
			alert('seleccione Región');
		}
	});
